...
class SensorTypeHistory {

    constructor() {
        console.log("sensor_type_history.js loaded...");
    }
    ...
    init() {
        ...
        parent.sensor_history_el = document.getElementById('history');
        parent.handle_history(parent, API_SENSOR_TYPE_HISTORY["history"]);
    }
    ...
    handle_history(parent, api_history) {
        ...
        if (history_length == 0) {
            ...
            parent.sensor_history_el.appendChild(error_div);
            return;
        }
        ...
        parent.sensor_history_el.appendChild(history_table);
    }
