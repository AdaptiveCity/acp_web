...
class FloorPlan {
    ...
    setup_crate(parent) {
        ...
        let translate_x = (tx * parent.svg_transform.scale);
        let translate_y = (ty * parent.svg_transform.scale);

        parent.svg_transform.scale *= scale_new;
        parent.svg_transform.x += translate_x*scale_new - bbox_floor_offset.e;
        parent.svg_transform.y += translate_y*scale_new - bbox_floor_offset.f;
        parent.svg_transform.transform = "translate(" + parent.svg_transform.x + "," + parent.svg_transform.y + ") " + "scale(" + parent.svg_transform.scale + ")"
