...
from .views import HomeView, MapView, BuildingView, FloorView, FloorspaceView, RainHomeView, RainView, SplashHomeView, SplashView, RotasView, RotasOGView, RotasROCView, Rotas2000,RotasHomeView
